...
# **1. Table of Contents**
|
| This document presents a non-exhaustive list of survival analysis and descriptive modelling methods for a two-group right-censored data with time-independent variables using various helpful packages in <mark style="background-color: #CCECFF">**R**</mark>.    
|
##  1.1 Sample Data
|
